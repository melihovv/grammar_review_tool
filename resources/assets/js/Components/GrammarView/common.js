export default {
  ...
  commentTemplate(
    ...
    return `<div class="grammar-view__comment-holder" ${commentId !== -1 ? 'comment-id="' + commentId + '"' : ''}><div class="grammar-view__comment-header">${userName} ${updateOrDelete ? this.svgDeleteComment + this.svgEditComment : ''}</div><div class="grammar-view__comment-content">${commentContent}</div></div>`
  },
}
